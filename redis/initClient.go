...
// NoOfReducerJobs is the number of redis instances that sit in between the shufflers and the reducers, and thus
// the number of reducer jobs that are run, by default this is 5.
var NoOfReducerJobs = 5
